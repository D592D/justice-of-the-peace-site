  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content="Randy Sampson JP – Justice of the Peace Guyana"
        />
        <meta
        ...
        <section className="relative bg-gradient-to-br from-slate-900 to-slate-800 text-white py-20">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg md:text-xl max-w-3xl mx-auto mb-10 leading-relaxed">
              ...
              and dedication to justice. Your trusted partner for essential
              legal services.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="#services"
                className="inline-block bg-amber-400 text-slate-900 px-8 py-3 rounded-lg font-semibold hover:bg-amber-300 transition duration-300 shadow-lg"
              >
                View Our Services
              </a>
              <a
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-slate-600 max-w-3xl mx-auto">
                We provide essential legal services to individuals and
                businesses throughout Guyana, ensuring accessible justice and
                professional support for all your documentation needs.
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      Carrying out responsibilities as appointed by the
                      President of Guyana to ensure legal fairness.
                    </p>
                  </div>
                </div>
              </div>
